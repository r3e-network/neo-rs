...
fn test_key_pair_generation() {
    ...
    assert!(key_pair.compressed_public_key()[0] == 0x02 || key_pair.compressed_public_key()[0] == 0x03); // Compressed prefix
}
...
fn test_key_pair_constructor_c_sharp_compatibility() {
    ...
    let expected_compressed_public_key = "026ff03b949241ce1dadd43519e6960e0a85b41a69a05c328103aa2bce1594ca16";
...
fn test_key_pair_export_c_sharp_compatibility() {
    ...
    assert_eq!(key_pair.compressed_public_key(), restored_key_pair.compressed_public_key());
}
...
fn test_deterministic_key_generation() {
    ...
    assert_eq!(key_pair1.compressed_public_key(), key_pair2.compressed_public_key());
