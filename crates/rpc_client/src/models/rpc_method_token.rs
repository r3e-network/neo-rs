...
impl RpcMethodToken {
    ...
    pub fn from_json(json: &JObject) -> Result<Self, String> {
        ...
        let parameters_count = json.get("paramcount")
            .and_then(|v| v.as_number())
            .ok_or("Missing or invalid 'paramcount' field")?
            as u16;
            
        let has_return_value = json.get("hasreturnvalue")
            .and_then(|v| v.as_boolean())
            .ok_or("Missing or invalid 'hasreturnvalue' field")?;
            
        let call_flags_str = json.get("callflags")
            .and_then(|v| v.as_string())
