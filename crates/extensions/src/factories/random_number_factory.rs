...
impl RandomNumberFactory {
    ...
    pub fn next_sbyte_range(min_value: i8, max_value: i8) -> i8 {
        ...
        (Self::next_u32_max((max_value - min_value) as u32) as i8) + min_value
    }
    ...
    pub fn next_byte_range(min_value: u8, max_value: u8) -> u8 {
        ...
        (Self::next_u32_max((max_value - min_value) as u32) as u8) + min_value
    }
    ...
    pub fn next_i16_range(min_value: i16, max_value: i16) -> i16 {
        ...
        (Self::next_u32_max((max_value - min_value) as u32) as i16) + min_value
    }
    ...
    pub fn next_u16_range(min_value: u16, max_value: u16) -> u16 {
        ...
        (Self::next_u32_max((max_value - min_value) as u32) as u16) + min_value
    }
    ...
    pub fn next_i32_range(min_value: i32, max_value: i32) -> i32 {
        ...
        (Self::next_u32_max((max_value - min_value) as u32) as i32) + min_value
    }
    ...
    pub fn next_i64_range(min_value: i64, max_value: i64) -> i64 {
        ...
        (Self::next_u64_max((max_value - min_value) as u64) as i64) + min_value
    }
