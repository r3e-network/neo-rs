...
fn test_contract_parameter_publickey_compatibility() {
    ...
    let pubkey_data = vec![
        0x03, 0x12, 0x34, 0x56, 0x78, 0x9a, 0xbc, 0xde,
...
fn test_contract_parameter_array_compatibility() {
    ...
    for element in &elements {
        ...
        assert_eq!(&serialized[offset..offset + element_serialized.len()], &element_serialized);
...
fn test_contract_parameter_deserialization_compatibility() {
    ...
    let test_cases = vec![
        ...
        (vec![0x12, 0x03, 0x01, 0x02, 0x03], ContractParameter::ByteArray(vec![1, 2, 3])),
