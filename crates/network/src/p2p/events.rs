...
impl P2PEvent {
    ...
    pub fn peer_disconnected(peer_id: UInt160, address: SocketAddr, reason: String) -> Self {
        Self::PeerDisconnected { peer_id, address, reason }
    }
    ...
    pub fn handshake_completed(peer_id: UInt160, address: SocketAddr, node_info: NodeInfo) -> Self {
        Self::HandshakeCompleted { peer_id, address, node_info }
    }
    ...
    pub fn peer_version(address: SocketAddr, version: u32, user_agent: String, start_height: u32) -> Self {
        Self::PeerVersion { address, version, user_agent, start_height }
    }

    /// Creates a network status event
    pub fn network_status(connected: bool, peer_count: usize) -> Self {
        Self::NetworkStatus { connected, peer_count }
    }
