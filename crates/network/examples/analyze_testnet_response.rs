...
fn main() {
    let response_hex =
        "0000254e33543500000000ecb689689c5a521c0b2f4e656f3a332e382e322f0210becd7c00016d4f";
            ...
            if response_bytes[i] == b'/' {
                ...
                if i > 0 {
                    ...
                    if i + len <= response_bytes.len() {
                        ...
                        println!(
                            "  Potential user agent at {}: len={}, value='{}'",
                            i - 1,
                            len,
    ...
    println!(
        "  TestNet magic bytes (LE): {:02x} {:02x} {:02x} {:02x}",
