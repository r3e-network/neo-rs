...
struct RegisteredDescriptor {
    descriptor: InteropDescriptor,
    hash: u32,
}

impl RegisteredDescriptor {
    fn new(descriptor: InteropDescriptor) -> VmResult<Self> {
...
impl InteropService {
    ...
    pub fn register(&mut self, descriptor: InteropDescriptor) -> VmResult<u32> {
    ...
    pub fn get_method(&self, name: &[u8]) -> Option<&InteropDescriptor> {
