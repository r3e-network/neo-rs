...
impl OpCode {
    ...
    pub fn iter() -> impl Iterator<Item = OpCode> {
        ...
        vec![
            Self::PUSHINT8, Self::PUSHINT16, Self::PUSHINT32, Self::PUSHINT64,
            Self::PUSHINT128, Self::PUSHINT256, Self::PUSHT, Self::PUSHF,
            Self::PUSHA, Self::PUSHNULL, Self::PUSHDATA1, Self::PUSHDATA2,
            Self::PUSHDATA4, Self::PUSHM1, Self::PUSH0, Self::PUSH1,
            Self::PUSH2, Self::PUSH3, Self::PUSH4, Self::PUSH5,
            Self::PUSH6, Self::PUSH7, Self::PUSH8, Self::PUSH9,
            Self::PUSH10, Self::PUSH11, Self::PUSH12, Self::PUSH13,
            Self::PUSH14, Self::PUSH15, Self::PUSH16, Self::NOP,
            Self::JMP, Self::JMP_L, Self::JMPIF, Self::JMPIF_L,
            Self::JMPIFNOT, Self::JMPIFNOT_L, Self::JMPEQ, Self::JMPEQ_L,
            Self::JMPNE, Self::JMPNE_L, Self::JMPGT, Self::JMPGT_L,
            Self::JMPGE, Self::JMPGE_L, Self::JMPLT, Self::JMPLT_L,
            Self::JMPLE, Self::JMPLE_L, Self::CALL, Self::CALL_L,
            Self::CALLA, Self::CALLT, Self::ABORT, Self::ASSERT,
            Self::THROW, Self::TRY, Self::TRY_L, Self::ENDTRY,
            Self::ENDTRY_L, Self::ENDFINALLY, Self::RET, Self::SYSCALL,
            Self::DEPTH, Self::DROP, Self::NIP, Self::XDROP,
            Self::CLEAR, Self::DUP, Self::OVER, Self::TOALTSTACK, Self::PICK,
            Self::TUCK, Self::FROMALTSTACK, Self::SWAP, Self::ROT, Self::ROLL,
            Self::REVERSE3, Self::REVERSE4, Self::REVERSEN, Self::INITSSLOT,
            Self::INITSLOT, Self::LDSFLD0, Self::LDSFLD1, Self::LDSFLD2,
            Self::LDSFLD3, Self::LDSFLD4, Self::LDSFLD5, Self::LDSFLD6,
            Self::LDSFLD, Self::STSFLD0, Self::STSFLD1, Self::STSFLD2,
            Self::STSFLD3, Self::STSFLD4, Self::STSFLD5, Self::STSFLD6,
            Self::STSFLD, Self::LDLOC0, Self::LDLOC1, Self::LDLOC2,
            Self::LDLOC3, Self::LDLOC4, Self::LDLOC5, Self::LDLOC6,
            Self::LDLOC, Self::STLOC0, Self::STLOC1, Self::STLOC2,
            Self::STLOC3, Self::STLOC4, Self::STLOC5, Self::STLOC6,
            Self::STLOC, Self::LDARG0, Self::LDARG1, Self::LDARG2,
            Self::LDARG3, Self::LDARG4, Self::LDARG5, Self::LDARG6,
            Self::LDARG, Self::STARG0, Self::STARG1, Self::STARG2,
            Self::STARG3, Self::STARG4, Self::STARG5, Self::STARG6,
            Self::STARG, Self::NEWBUFFER, Self::MEMCPY, Self::CAT,
            Self::SUBSTR, Self::LEFT, Self::RIGHT, Self::INVERT,
            Self::AND, Self::OR, Self::XOR, Self::EQUAL,
            Self::NOTEQUAL, Self::SIGN, Self::ABS, Self::NEGATE,
            Self::INC, Self::DEC, Self::ADD, Self::SUB,
            Self::MUL, Self::DIV, Self::MOD, Self::POW,
            Self::SQRT, Self::MODMUL, Self::MODPOW, Self::SHL,
            Self::SHR, Self::NOT, Self::BOOLAND, Self::BOOLOR,
            Self::NZ, Self::NUMEQUAL, Self::NUMNOTEQUAL, Self::LT,
            Self::LE, Self::GT, Self::GE, Self::MIN,
            Self::MAX, Self::WITHIN, Self::PACKMAP, Self::PACKSTRUCT,
            Self::PACK, Self::UNPACK, Self::NEWARRAY0, Self::NEWARRAY,
            Self::NEWARRAY_T, Self::NEWSTRUCT0, Self::NEWSTRUCT, Self::NEWMAP,
            Self::SIZE, Self::HASKEY, Self::KEYS, Self::VALUES,
            Self::PICKITEM, Self::APPEND, Self::SETITEM, Self::REVERSEITEMS,
            Self::REMOVE, Self::CLEARITEMS, Self::POPITEM, Self::ISNULL,
            Self::ISTYPE, Self::CONVERT, Self::ABORTMSG, Self::ASSERTMSG,
        ].into_iter()
    }
...
impl TryFrom<u8> for OpCode {
    ...
    fn try_from(value: u8) -> Result<Self, Self::Error> {
        Self::from_byte(value).ok_or_else(|| crate::Error::InvalidOpCode(value))
    }
}
