...
use neo_core::{UInt160, UInt256, io::{ISerializable, MemoryReader, BinaryWriter}};
use std::num::BigInt;
...
impl TokenTransfer {
    ...
    pub fn new_with_params(user_script_hash: UInt160, block_index: u32, tx_hash: UInt256, amount: BigInt) -> Self {
        Self {
            user_script_hash,
            block_index,
            tx_hash,
