...
| Bounded optimistic header signature pool | **OPT-IN FOUNDATION 2026-07-20** — typed receipts, bounded look-ahead window, ordered publication fence, synchronous fallback, fixed-cardinality counters; no end-to-end node speedup established | `neo-blockchain::pipeline::signature_verification`; `reports/performance/optimistic-signature-verification-20260720.md`; transaction signatures remain admission/audit-only until protocol differential proof |
