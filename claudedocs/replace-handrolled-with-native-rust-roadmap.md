...
| 7 | **ServiceRegistry** (C# `IServiceProvider`/TypeId locator) | Concrete typed fields on `NeoSystem`/`NeoSystemContext`; constructor injection | none (std) | `neo_system/{core,context,services}.rs`; RPC + startup indirect | No | L | **P2** |
