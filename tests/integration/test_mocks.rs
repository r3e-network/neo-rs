...
pub mod network {
    ...
    pub mod sync {
        ...
        impl SyncManager {
            ...
            pub async fn sync_headers(&self) -> Result<(), Box<dyn std::error::Error>> {
                Ok(())
            }
            ...
            pub async fn get_header(
                &self,
                _height: u32,
            ) -> Option<crate::test_mocks::ledger::BlockHeader> {
                None
            }
            pub async fn get_peer_statistics(&self) -> HashMap<u64, PeerStats> {
                HashMap::new()
            }
...
pub mod consensus {
    ...
    impl DbftEngine {
        ...
        pub async fn start_consensus_round(&self) -> Result<(), Box<dyn std::error::Error>> {
            Ok(())
        }
        pub async fn handle_consensus_message(
            &self,
            _msg: messages::ConsensusMessage,
        ) -> Result<(), Box<dyn std::error::Error>> {
            Ok(())
        }
        pub async fn get_last_agreed_block(&self) -> Option<crate::test_mocks::ledger::Block> {
            None
        }
        pub async fn start_view_timer(&self) {}
        pub async fn get_current_view(&self) -> u32 {
            0
        }
        pub async fn get_consensus_context(&self) -> ConsensusContext {
            ConsensusContext
        }
        pub async fn create_recovery_request(&self) -> RecoveryRequest {
            RecoveryRequest
        }
        pub async fn create_recovery_message(&self, _req: &RecoveryRequest) -> RecoveryMessage {
            RecoveryMessage
        }
        pub async fn handle_recovery_message(
            &self,
            _msg: RecoveryMessage,
        ) -> Result<(), Box<dyn std::error::Error>> {
            Ok(())
        }
    ...
    impl ConsensusContext {
        ...
        pub async fn get_phase(&self) -> ConsensusPhase {
            ConsensusPhase::RequestSent
        }
        pub async fn get_prepare_response_count(&self) -> usize {
            0
        }
...
pub mod rpc_client {
    ...
    impl RpcClient {
        ...
        pub async fn get_block(
            &self,
            _height: u32,
        ) -> Result<crate::test_mocks::ledger::Block, Box<dyn std::error::Error>> {
