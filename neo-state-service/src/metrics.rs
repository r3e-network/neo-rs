...
impl StateRootApplyStage {
    ...
    fn slot_index(self) -> usize {
        match self {
            Self::MutateChanges => 0,
            Self::RootHash => 1,
            Self::TrieCommit => 2,
            Self::OverlayPrepare => 3,
            Self::BackingCommit => 4,
            Self::PublishGeneration => 5,
        }
    }
}
...
static APPLY_STAGE_ORDER: [StateRootApplyStage; 6] = [
...
static APPLY_STAGES: [TimingMetricSlot; 6] = [
