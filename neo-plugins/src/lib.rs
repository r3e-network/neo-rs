...
// Re-export common types from neo-core extensions
pub use neo_core::extensions::error::{ExtensionError, ExtensionResult};
pub use neo_core::extensions::plugin::{
...
impl PluginCollection {
    ...
    pub fn all_plugins() -> Vec<Box<dyn Plugin>> {
        vec![
            ...
            Box::new(rocksdb_store::RocksDBStorePlugin::new()),
