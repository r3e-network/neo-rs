    ...
    [
        ...
        (
            ...
            concat!(
                ...
                "\n",
                include_str!("../ledger_contract.rs"),
            ),
        ),
        (
            "NeoToken",
            concat!(
                include_str!("../neo_token/storage.rs"),
                "\n",
        ...
        (
            ...
            concat!(
                ...
                "\n",
                include_str!("../role_management.rs"),
            ),
        ),
        (
            "OracleContract",
            concat!(
                ...
                "\n",
                include_str!("../oracle_contract.rs"),
            ),
        ),
        (
            "Notary",
