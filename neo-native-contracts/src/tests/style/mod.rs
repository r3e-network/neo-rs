    ...
    [
        ...
        (
            ...
            concat!(
                ...
                "\n",
                include_str!("../../neo_token/storage/account.rs"),
                "\n",
                include_str!("../../neo_token/storage/candidates.rs"),
                "\n",
                include_str!("../../neo_token/storage/committee.rs"),
                "\n",
                include_str!("../../neo_token/storage/economics.rs"),
                "\n",
                include_str!("../../neo_token/storage/keys.rs"),
                "\n",
                include_str!("../../neo_token/storage/mod.rs"),
                "\n",
                include_str!("../../neo_token/storage/points.rs"),
                "\n",
                ...
                "\n",
                include_str!("../../neo_token/initialize.rs"),
                "\n",
                include_str!("../../neo_token/metadata.rs"),
                "\n",
                include_str!("../../neo_token/persist.rs"),
                "\n",
                include_str!("../../neo_token/providers.rs"),
                "\n",
