...
//! [`super::dotnet_graphemes`] that was generated from — and verified code
...
use super::dotnet_graphemes::DOTNET_GRAPHEME_BREAK_RANGES;
...
#[cfg(test)]
#[path = "../tests/text/dotnet_text_segmentation.rs"]
mod tests;
