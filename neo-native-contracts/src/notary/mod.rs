...
use neo_primitives::{TransactionAttributeType, UInt160, WitnessScope};
    ...
    fn invoke(
        ...
        match method {
            ...
            "lockDepositUntil" => {
                ...
                let till = crate::args::raw_u32_arg(args, 1, "Notary::lockDepositUntil").map_err(
                    |_| {
                        CoreError::invalid_operation(
