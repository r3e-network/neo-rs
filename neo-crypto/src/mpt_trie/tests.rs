...
mod mpt_tests {
    ...
    fn test_genesis_state_root_matches_reference() {
        ...
        trie.put(
            &hex::decode("f7ffffff05").unwrap(),
            &hex::decode("80f0fa02").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("f7ffffff09").unwrap(),
            &hex::decode("").unwrap(),
        )
        .unwrap();
        // PolicyContract (ID -7, prefix f9ffffff)
        trie.put(
            &hex::decode("f9ffffff0a").unwrap(),
            &hex::decode("e803").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("f9ffffff12").unwrap(),
            &hex::decode("1e").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("f9ffffff13").unwrap(),
            &hex::decode("a08601").unwrap(),
        )
        .unwrap();
        // GasToken (ID -6, prefix faffffff)
        trie.put(
            &hex::decode("faffffff0b").unwrap(),
            &hex::decode("80f0cf5b5f7912").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("faffffff146b123dd8bec718648852bbc78595e3536a058f9f").unwrap(),
            &hex::decode("410121070000d5585f7912").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("faffffff1496949ed482e7c60aaeec691550f1b3d599146194").unwrap(),
            &hex::decode("4101210480f0fa02").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("fbffffff01").unwrap(),
            &hex::decode("").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("fbffffff0b").unwrap(),
            &hex::decode("00e1f505").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("fbffffff0d").unwrap(),
            &hex::decode("00e8764817").unwrap(),
        )
        .unwrap();
        ...
        trie.put(
            &hex::decode("fbffffff146b123dd8bec718648852bbc78595e3536a058f9f").unwrap(),
            &hex::decode("4104210400e1f5052100002100").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("fbffffff1d00000000").unwrap(),
            &hex::decode("0065cd1d").unwrap(),
        )
        .unwrap();
        ...
        trie.put(
            &hex::decode("ffffffff0cfffffff7").unwrap(),
            &hex::decode("588717117e0aa81072afab71d2dd89fe7c4b92fe").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("ffffffff0cfffffff8").unwrap(),
            &hex::decode("e295e391544c178ad94f03ec4dcdff78534ecf49").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("ffffffff0cfffffff9").unwrap(),
            &hex::decode("7bc681c0a1f71d543457b68bba8d5f9fdd4e5ecc").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("ffffffff0cfffffffa").unwrap(),
            &hex::decode("cf76e28bd0062c4a478ee35561011319f3cfa4d2").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("ffffffff0cfffffffb").unwrap(),
            &hex::decode("f563ea40bc283d4d0e05c48ea305b3f2a07340ef").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("ffffffff0cfffffffc").unwrap(),
            &hex::decode("bef2043140362a77c15099c7e64c12f700b665da").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("ffffffff0cfffffffd").unwrap(),
            &hex::decode("1bf575ab1189688413610a35a12886cde0b66c72").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("ffffffff0cfffffffe").unwrap(),
            &hex::decode("c0ef39cee0e4e925c6c2a06a79e1440dd86fceac").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("ffffffff0cffffffff").unwrap(),
            &hex::decode("fda3fa4346ea532a258fc497ddaddb6437c9fdff").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("ffffffff0f").unwrap(),
            &hex::decode("01").unwrap(),
        )
        .unwrap();
        trie.put(
            &hex::decode("ffffffff14").unwrap(),
            &hex::decode("00ca9a3b").unwrap(),
        )
        .unwrap();
        ...
        assert_eq!(
            root_hex, "e881de01a3172b4988a8cd6194b82ab18eec47171f2931f6abee997e7b15a558",
            "genesis state root must match C# reference (LE bytes)"
        );
    }
    ...
    fn test_genesis_state_root_with_full_state_true() {
        ...
        let entries: Vec<(&str, &str)> = vec![
            ...
            (
                "faffffff146b123dd8bec718648852bbc78595e3536a058f9f",
                "410121070000d5585f7912",
            ),
            (
                "faffffff1496949ed482e7c60aaeec691550f1b3d599146194",
                "4101210480f0fa02",
            ),
            ("fbffffff01", ""),
            ("fbffffff0b", "00e1f505"),
