...
/// a burst sync of several hundred blocks without lagging the producer, while
/// keeping the in-memory queue bounded.
pub const DEFAULT_EVENT_CAPACITY: usize = 1024;

/// Default capacity of the blockchain command channel. Sized to match the
/// broadcast capacity so a burst of imports does not block senders before the
