...
#[inline]
pub const fn sign_contract_cost() -> u64 {
    PUSH_DATA1_PRICE + SYSCALL_PRICE + CHECK_SIG_COST
}

#[inline]
pub fn multi_sign_contract_cost(nr_keys: u32, nr_signs: u32) -> u64 {
    PUSH_DATA1_PRICE * (nr_keys + nr_signs) as u64
        + PUSH_INT_PRICE
        + PUSH_INT_PRICE
        + SYSCALL_PRICE
        + CHECK_SIG_COST * nr_signs as u64
}
