...
//!
//! A batch is deliberately only a transport result: it records the supplying
//! peer, the first height, and the canonical block bodies. Runtime sync code
//! converts it into `neo_runtime::SyncBlockBatch` before import.
