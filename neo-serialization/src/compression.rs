...
use neo_io::compress_lz4 as io_compress_lz4;
use neo_io::decompress_lz4 as io_decompress_lz4;
...
pub fn compress_lz4(data: &[u8]) -> neo_error::Result<Vec<u8>> {
    io_compress_lz4(data).map_err(|e| CoreError::compression(e.to_string()))
}
...
pub fn decompress_lz4(data: &[u8], max_size: usize) -> neo_error::Result<Vec<u8>> {
    io_decompress_lz4(data, max_size).map_err(|e| CoreError::compression(e.to_string()))
}
