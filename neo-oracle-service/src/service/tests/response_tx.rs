...
use neo_core::persistence::storage_key::StorageKey;
use neo_core::persistence::DataCache;
use neo_core::protocol_settings::ProtocolSettings;
use neo_core::smart_contract::native::{LedgerContract, OracleRequest};
...
fn create_response_tx_matches_csharp_fee_math() {
    ...
    let system =
        neo_core::neo_system::NeoSystem::new(settings.clone(), None, None).expect("neo system");
