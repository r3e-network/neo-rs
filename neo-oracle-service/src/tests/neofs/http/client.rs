use super::super::super::OracleNeoFsProtocol;
use crate::service::OracleServiceError;

#[test]
fn invalid_neofs_http_client_builder_returns_typed_startup_error() {
    let result =
        OracleNeoFsProtocol::from_builder(reqwest::Client::builder().user_agent("bad\nagent"));
