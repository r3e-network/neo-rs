...
use neo_execution::ContractParameterType;
use neo_wallets::wallet_account::WalletAccount;
use neo_wallets::{Version, Wallet, WalletError, WalletResult};
...
use neo_wallets::signature_invocation;
...
impl Wallet for HsmWallet {
    ...
    async fn create_account_with_contract(
        &self,
        _contract: Contract,
        _key_pair: Option<neo_wallets::KeyPair>,
...
impl WalletAccount for HsmWalletAccount {
    ...
    fn get_key(&self) -> Option<neo_wallets::KeyPair> {
        None
   }
