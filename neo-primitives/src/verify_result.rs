...
protocol_enum! {
    ...
    pub VerifyResult {
        ...
        Expired = 10,
        /// The transaction's `ValidUntilBlock` is too far in the future
        /// (more than `MaxValidUntilBlockIncrement` ahead of the current
        /// height). C# v3.10.0 `VerifyResult.NotYetValid`.
        NotYetValid = 11,
