...
pub trait TransactionAttribute: SerializableTrait {
    ...
    /// Deserializes an transaction_attribute object from a MemoryReader.
    ...
    /// Deserializes the transaction_attribute object from a MemoryReader.
    ...
    /// Serializes the transaction_attribute object to a BinaryWriter.
