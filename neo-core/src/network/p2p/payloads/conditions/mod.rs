//! Witness condition helpers for network payloads.
//!
//! The canonical condition implementation lives in [`crate::witness_rule`].
//! These modules preserve the historical P2P helper paths while avoiding a
//! one-file-per-condition facade.
