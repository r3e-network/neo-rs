...
// `ConnectionState` lives in its own module; re-exported here so existing
// `p2p::connection::ConnectionState` paths keep resolving.
pub use super::connection_state::ConnectionState;
