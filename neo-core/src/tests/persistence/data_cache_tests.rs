...
mod data_cache_tests {
    ...
    fn test_data_cache_add_and_get() {
        ...
        // DataCache::add adds item to cache
    }
    ...
    fn test_data_cache_delete() {
        ...
        cache.add(key.clone(), item.clone());
        cache.delete(&key);
        // DataCache::delete removes item from cache
    }
    ...
    fn test_data_cache_snapshot() {
        ...
        // DataCache can be cloned for snapshot
    }
    ...
    fn test_storage_key_with_uint256() {
        ...
        // StorageKey can be created with uint256 prefix
    }
