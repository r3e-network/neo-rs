...
///
/// This is a thin alias over [`crate::neo_vm::slot::Slot`] so existing call sites
/// can continue to reference `execution_context::Slot`.
pub type Slot = crate::neo_vm::slot::Slot;
...
pub struct SharedStates {
    ...
    evaluation_stack: Arc<Mutex<crate::neo_vm::evaluation_stack::EvaluationStack>>,
...
impl SharedStates {
    ...
    #[must_use]
    pub fn new(script: crate::neo_vm::script::Script, reference_counter: ReferenceCounter) -> Self {
        let script = Arc::new(script);
        Self {
            script: Arc::clone(&script),
            evaluation_stack: Arc::new(Mutex::new(
                crate::neo_vm::evaluation_stack::EvaluationStack::new(reference_counter.clone()),
            )),
    ...
    #[must_use]
    pub fn script(&self) -> &crate::neo_vm::script::Script {
        self.script.as_ref()
    }

    /// Returns the script as an `Arc` for cloning.
    #[must_use]
    pub fn script_arc(&self) -> Arc<crate::neo_vm::script::Script> {
    ...
    pub fn evaluation_stack(
        &self,
    ) -> parking_lot::MutexGuard<'_, crate::neo_vm::evaluation_stack::EvaluationStack> {
...
impl ExecutionContext {
    ...
    pub fn static_fields_len(&self) -> usize {
        self.with_static_fields_mut(|static_fields| {
            static_fields
                .as_ref()
                .map_or(0, crate::neo_vm::slot::Slot::len)
        })
    }
    ...
    #[inline(always)]
    pub fn push(&mut self, mut item: crate::neo_vm::stack_item::StackItem) -> VmResult<()> {
    ...
    #[inline(always)]
    pub fn pop(&mut self) -> VmResult<crate::neo_vm::stack_item::StackItem> {
        self.shared_states.evaluation_stack_mut().pop()
    }

    /// Peek at an item on the evaluation stack without removing it
    #[inline(always)]
    pub fn peek(&self, index: usize) -> VmResult<crate::neo_vm::stack_item::StackItem> {
    ...
    pub fn insert(
        ...
        item: crate::neo_vm::stack_item::StackItem,
    ) -> VmResult<()> {
        self.shared_states
    ...
    pub fn load_static_field(
        &self,
        index: usize,
    ) -> VmResult<crate::neo_vm::stack_item::StackItem> {
    ...
    pub fn store_static_field(
        &mut self,
        index: usize,
        value: crate::neo_vm::stack_item::StackItem,
    ) -> VmResult<()> {
        self.shared_states.with_static_fields_mut(|static_fields| {
            if let Some(static_fields) = static_fields.as_mut() {
    ...
    pub fn load_local(&self, index: usize) -> VmResult<crate::neo_vm::stack_item::StackItem> {
    ...
    pub fn load_argument(&self, index: usize) -> VmResult<crate::neo_vm::stack_item::StackItem> {
