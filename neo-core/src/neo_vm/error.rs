...
pub enum VmError {
    ...
    UnhandledException(
        ...
        crate::neo_vm::stack_item::StackItem,
    ),
...
impl From<crate::neo_vm::io::IoError> for VmError {
    fn from(error: crate::neo_vm::io::IoError) -> Self {
        match error {
            crate::neo_vm::io::IoError::Format => Self::parse("format error"),
            crate::neo_vm::io::IoError::InvalidUtf8 => Self::parse("invalid utf-8 data"),
            crate::neo_vm::io::IoError::InvalidData { context, value } => {
                Self::parse(format!("{context}: {value}"))
            }
            crate::neo_vm::io::IoError::Io(inner) => Self::io(inner.to_string()),
        }
    }
}
