...
use crate::neo_vm::{VmError, VmResult};
...
impl ExecutionEngineLimits {
    ...
    pub const DEFAULT: Self = Self {
        max_shift: 256,
        max_stack_size: neo_vm_rs::DEFAULT_MAX_STACK_DEPTH as u32,
        // Neo N3 uses ushort.MaxValue here; neo-vm-rs::MAX_ITEM_SIZE is larger.
        max_item_size: u16::MAX as u32,
        max_comparable_size: u16::MAX as u32, // C#: ushort.MaxValue = 65535
        max_invocation_stack_size: neo_vm_rs::DEFAULT_MAX_INVOCATION_DEPTH as u32,
