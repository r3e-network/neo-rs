...
use super::converters::{convert_ledger_block, convert_ledger_header, convert_payload_block};
use super::helpers::{block_on_extension, initialise_plugins, to_core_error};
use super::registry::ServiceRegistry;
use super::relay::{
    RelayExtensibleCache, RelayExtensibleEntry, LEDGER_HYDRATION_WINDOW, RELAY_CACHE_CAPACITY,
};

use akka::{ActorRef, ActorSystem, ActorSystemHandle, EventStreamHandle};
...
use crate::ledger::{
    block::Block as LedgerBlock, blockchain_application_executed::ApplicationExecuted, HeaderCache,
    LedgerContext, MemoryPool,
};
...
use crate::persistence::{
    data_cache::DataCache, i_store::IStore, i_store_provider::IStoreProvider, StoreCache,
    StoreFactory, StoreTransaction,
};
...
// ReadinessStatus and STATE_STORE_SERVICE have been extracted to super::system module
use super::system::{ReadinessStatus, STATE_STORE_SERVICE};

// ServiceRegistry has been extracted to super::registry module
...
impl NeoSystemContext {
    ...
    // convert_* functions have been extracted to super::converters module
...
// downcast_service has been moved to super::registry module
// create_genesis_block has been moved to super::genesis module
