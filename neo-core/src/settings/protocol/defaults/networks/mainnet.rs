...
pub(crate) const MAINNET: NetworkDefaults = NetworkDefaults {
    magic: 860_833_102,
    ...
    hardforks: &[
        (Hardfork::Aspidochelone, 1_730_000),
        (Hardfork::Basilisk, 4_120_000),
        (Hardfork::Cockatrice, 5_450_000),
        (Hardfork::Domovoi, 5_570_000),
        (Hardfork::Echidna, 7_300_000),
    ],
};
