...
pattern_descs=(
    ...
    "Rust unimplemented!() macro found"
    "Rust todo!() macro found"
    "Rust panic! with todo message found"
    "Rust panic! with fixme message found"
    "Rust dead code with TODO found"
    "Rust debug println! found"
    "Rust debug eprintln! found"
    "Rust dbg! macro found"
)
