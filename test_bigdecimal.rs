...
fn main() {
    ...
    println!("Changed to 7 decimals: {} (value: {})", result1, result1.value());
    ...
    println!("Changed to 3 decimals: {} (value: {})", result2, result2.value());
    ...
    println!("Parsed '123.45' with 2 decimals: {} (value: {})", parsed, parsed.value());
