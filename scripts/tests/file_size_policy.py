...
RUST_SIZE_BASELINE = {
    ...
    "neo-blockchain/src/tests/pipeline/native_persist.rs": 1119,
    "neo-execution/src/tests/application_engine/contracts.rs": 1707,
    "neo-node/src/bin/neo-db-probe.rs": 1397,
    "neo-node/src/tests/node/chain_acc/mod.rs": 1439,
    "neo-node/src/tests/node/fast_sync/mod.rs": 1011,
    "neo-node/src/tests/node/runtime.rs": 2127,
    "neo-runtime/src/service/sync_metrics.rs": 939,
...
OPERATIONAL_PYTHON_SIZE_BASELINE = {
    ...
    "scripts/run-bounded-mainnet-replay.py": 1658,
