...
class RpcFileSizeLimitTests(unittest.TestCase):
    ...
    def test_rpc_state_tests_keep_mpt_and_findstates_coverage_split(self):
        assert_file_limits(
            self,
            {
                "neo-rpc/src/server/rpc_server_state/tests.rs": 160,
                "neo-rpc/src/server/rpc_server_state/tests/basics.rs": 160,
                "neo-rpc/src/server/rpc_server_state/tests/proof.rs": 180,
                "neo-rpc/src/server/rpc_server_state/tests/mpt_fixture.rs": 160,
                "neo-rpc/src/server/rpc_server_state/tests/state_queries.rs": 180,
                "neo-rpc/src/server/rpc_server_state/tests/state_gates.rs": 120,
                "neo-rpc/src/server/rpc_server_state/tests/find_states.rs": 240,
            },
    ...
    def test_rpc_utility_handlers_keep_inventory_split(self):
        assert_file_limits(
            self,
            {
                "neo-rpc/src/server/rpc_server_utilities.rs": 170,
                ...
                "neo-rpc/src/server/rpc_server_utilities/tests.rs": 260,
            },
    ...
    def test_rpc_indexer_tests_keep_records_status_and_errors_split(self):
        assert_file_limits(
            self,
            {
                "neo-rpc/src/server/rpc_server_indexer/tests.rs": 80,
                "neo-rpc/src/server/rpc_server_indexer/tests/support.rs": 120,
                "neo-rpc/src/server/rpc_server_indexer/tests/records.rs": 300,
                "neo-rpc/src/server/rpc_server_indexer/tests/status.rs": 160,
                "neo-rpc/src/server/rpc_server_indexer/tests/params.rs": 190,
                "neo-rpc/src/server/rpc_server_indexer/tests/errors.rs": 120,
            },
    ...
    def test_rpc_indexer_handlers_keep_status_params_and_responses_split(self):
        assert_file_limits(
            self,
            {
                "neo-rpc/src/server/rpc_server_indexer.rs": 330,
