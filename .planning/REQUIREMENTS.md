...
- [x] **BUILD-01**: A clean checkout passes locked workspace, fuzz, container, and dependency-policy builds without a sibling repository or undeclared local input.
